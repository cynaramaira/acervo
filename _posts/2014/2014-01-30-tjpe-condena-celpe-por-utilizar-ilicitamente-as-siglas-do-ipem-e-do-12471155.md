...
---
{% raw %}
<p>A Companhia Energética de Pernambuco (Celpe) foi condenada por elaborar laudos de aferição técnica de medidores de energia de vários usuários, utilizando ilicitamente os nomes do Instituto de Pesos e Medidas do Estado de Pernambuco (Ipem/PE) e do Instituto Nacional de Metrologia, Normalização e Qualidade Industrial (Inmetro).</p>
